...
## Read when…
- working in the indexer → [src/modules/repo-intel/AGENTS.md](src/modules/repo-intel/AGENTS.md)
- editing the review engine → [../reviewer-core/AGENTS.md](../reviewer-core/AGENTS.md)
