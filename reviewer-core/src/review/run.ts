...
export interface ReviewInput {
  ...
  /**
   * Derived PR intent/scope, pre-formatted as a compact string by the caller
   * (untrusted; delimiter-wrapped downstream). Rendered as a `## Review scope`
   * section right after the PR description. Empty/undefined → section omitted.
   */
  intent?: string;
